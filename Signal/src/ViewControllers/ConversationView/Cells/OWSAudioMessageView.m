...
//    self.audioDurationSeconds = [self.attachmentStream audioDurationSecondsWithoutTransaction];
...
//    [JSQMessagesMediaViewBubbleImageMasker applyBubbleImageMaskToMediaView:mediaView isOutgoing:!self.isIncoming];
