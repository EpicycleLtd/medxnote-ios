...
//{
//    return self.attachmentStream.uniqueId;
//}
...
//{
//    return [self.attachmentStream.uniqueId hash];
//}
...
//        self = [[UIView alloc] initWithFrame:CGRectMake(0.f, 0.f, viewSize.width, viewSize.height)];
    
        self.backgroundColor = self.bubbleBackgroundColor;
//        [JSQMessagesMediaViewBubbleImageMasker applyBubbleImageMaskToMediaView:self
...
//        if (!self.isIncoming) {
//            self.attachmentStreamUploadView = [[AttachmentUploadView alloc] initWithAttachment:self.attachmentStream
//                                                                               superview:self
...
//        if (!data) {
//            OWSFail(@"%@ Could not load data: %@", [self tag], [self.attachmentStream mediaURL]);
//            return;
//        }
...
//        DDLogError(@"'%@' action unsupported for %@: attachmentId=%@", actionString, [self class], self.attachmentStreamId);
//    }
//}
