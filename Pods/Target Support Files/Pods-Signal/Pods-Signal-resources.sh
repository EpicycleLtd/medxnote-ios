...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../SignalServiceKit/src/Security/PinningCertificate/GIAG2.crt"
  install_resource "${PODS_ROOT}/../SignalServiceKit/src/Security/PinningCertificate/GSR2.crt"
  install_resource "${PODS_ROOT}/../SignalServiceKit/src/Security/PinningCertificate/GSR4.crt"
  install_resource "${PODS_ROOT}/../SignalServiceKit/src/Security/PinningCertificate/GTSR1.crt"
  install_resource "${PODS_ROOT}/../SignalServiceKit/src/Security/PinningCertificate/GTSR2.crt"
  install_resource "${PODS_ROOT}/../SignalServiceKit/src/Security/PinningCertificate/GTSR3.crt"
  install_resource "${PODS_ROOT}/../SignalServiceKit/src/Security/PinningCertificate/GTSR4.crt"
fi
